...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/TwisteFate/podTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'TwisteFate' => 'linnan@dpandora.cn' }
  s.source           = { :git => 'https://github.com/TwisteFate/podTest.git', :tag => s.version.to_s }
